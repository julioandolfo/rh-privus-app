...
function get_page_permissions() {
    $default_permissions = [
        ...
        'lms/cursos.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/curso_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/curso_edit.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/curso_view.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/aulas.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/aula_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/aula_edit.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/categorias_cursos.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/avaliacoes.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/avaliacao_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/relatorios_lms.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/certificados_gerenciar.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/badges.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms/cursos_obrigatorios.php' => ['ADMIN', 'RH', 'GESTOR'],
        ...
        'lms_cursos.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_curso_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_curso_edit.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_curso_view.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_aulas.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_aula_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_aula_edit.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_categorias_cursos.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_avaliacoes.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_avaliacao_add.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_relatorios.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_certificados_gerenciar.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_badges.php' => ['ADMIN', 'RH', 'GESTOR'],
        'lms_cursos_obrigatorios.php' => ['ADMIN', 'RH', 'GESTOR'],
