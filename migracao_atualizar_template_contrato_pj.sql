-- Migração: Insere novo template "Contrato de Prestação de Serviços PJ - Por Hora"
-- Modelo baseado no contrato novo com pagamento por hora trabalhada
-- Variáveis: {{colaborador.valor_hora}} e {{colaborador.valor_hora_extenso}}
-- Cláusula 2.9: envio de documentos dia 01 e 15 de cada mês

INSERT INTO contratos_templates (nome, descricao, conteudo_html, variaveis_disponiveis, ativo, criado_por_usuario_id)
VALUES (
    'Contrato de Prestação de Serviços PJ - Por Hora',
    'Contrato para prestadores PJ remunerados por hora técnica trabalhada, com timesheet mensal. Envio de documentos nos dias 01 e 15.',
    ...
    <p style="text-align: justify; margin-left: 20px; margin-bottom: 15px;">
        5.4. A fiscalização da CONTRATANTE recairá exclusivamente sobre a qualidade das entregas, produtividade e resultados alcançados, e não sobre o tempo à disposição ou o modo de execução das tarefas.
    </p>
    ...
    <!-- CLÁUSULA 7 - DESPESAS -->
    <p style="text-align: justify; margin-bottom: 15px;">
        <strong>7. Despesas:</strong> Qualquer despesa relativa à prestação do serviço, como deslocamento, computadores e similares, mas não se limitando à estas, e especialmente as decorrentes de contratação de mão-de-obra, inclusive contribuições previdenciárias e encargos trabalhistas, são de exclusiva responsabilidade da CONTRATADA. Nenhum outro pagamento será devido pela prestação de serviços.
    </p>
    ...
    <p style="text-align: justify; margin-bottom: 15px;">
        <strong>10. Rescisão:</strong> O presente contrato poderá ser rescindido por qualquer uma das partes, a qualquer tempo, mediante simples comunicação por escrito, sem a necessidade de cumprimento de antecedência entre a comunicação de rescisão e o efetivo fim do contrato e sem incidência de qualquer penalidade ou multa rescisória, ressalvado o pagamento proporcional às horas efetivamente trabalhadas até a data da rescisão.
    </p>
    ...
    <p style="text-align: justify; margin-bottom: 5px;">
        <strong>4. DA NÃO EXCLUSIVIDADE:</strong>
    </p>
    <p style="text-align: justify; margin-left: 20px; margin-bottom: 5px;">
        4.1. Para evitar qualquer alegação de dependência econômica ou vínculo empregatício, as partes ajustam a seguinte disposição:
    </p>
    <p style="text-align: justify; margin-left: 40px; margin-bottom: 5px;">
        4.1.1. A prestação de serviços objeto deste contrato é realizada sem qualquer caráter de exclusividade.
    </p>
    <p style="text-align: justify; margin-left: 40px; margin-bottom: 15px;">
        4.1.2. A CONTRATADA é livre para prestar serviços de mesma natureza ou de naturezas diversas para quaisquer outros clientes ou empresas, inclusive concorrentes da CONTRATANTE, desde que respeitadas as normas de sigilo e confidencialidade previstas neste ANEXO II.
    </p>

    <p style="text-align: justify; margin-bottom: 5px;">
        <strong>5. RESPONSABILIDADE PÓS-CONTRATO:</strong>
    </p>
    <p style="text-align: justify; margin-left: 20px; margin-bottom: 5px;">
        5.1. Após o término do relacionamento das partes, a CONTRATADA não deve, direta ou indiretamente, revelar a qualquer pessoa, firma ou corporação os nomes ou endereços de qualquer dos consumidores/clientes da CONTRATANTE ou qualquer outra informação pertencente à eles, ou pedir, solicitar, tomar ou tentar tomar, solicitar, ou levar qualquer consumidor/cliente da CONTRATANTE, seja pra si mesmo ou para qualquer outra pessoa, firma ou corporação.
    </p>
    <p style="text-align: justify; margin-left: 20px; margin-bottom: 5px;">
        5.2. As obrigações previstas neste ANEXO II sobreviverão ao término ou rescisão deste contrato.
    </p>
    <p style="text-align: justify; margin-left: 20px; margin-bottom: 5px;">
        5.3. As partes se obrigam a comunicar e fazer com que os empregados, prepostos, ou terceiros sob sua responsabilidade, cumpram os termos desta Cláusula, impedindo o uso indevido de informações umas das outras.
    </p>
    <p style="text-align: justify; margin-left: 40px; margin-bottom: 30px;">
        5.3.1. As obrigações do CONTRATADA sobre os segredos de mercado e informação confidencial devem continuar em efeito além do período de relacionamento como definido acima e dita obrigação deve ser ligada ao cônjuge/esposa dos sócios do CONTRATADA, seus afiliados, atribuídos, herdeiros, parceiros, administradores, ou outros representantes legais.
    </p>
