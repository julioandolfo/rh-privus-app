...
$page_title = 'Adicionar Template de Contrato';
require_once __DIR__ . '/../includes/functions.php';
require_once __DIR__ . '/../includes/auth.php';
require_once __DIR__ . '/../includes/permissions.php';
require_once __DIR__ . '/../includes/contratos_functions.php';

require_page_permission('contrato_template_add.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        redirect('contrato_templates.php', 'Template criado com sucesso!', 'success');
    } catch (PDOException $e) {
        redirect('contrato_template_add.php', 'Erro ao criar template: ' . $e->getMessage(), 'error');
    }
}
...
<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column me-5 py-2">
            <h1 class="d-flex flex-column text-gray-900 fw-bold fs-3 mb-0">Adicionar Template de Contrato</h1>
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                ...
                <li class="breadcrumb-item text-gray-900">Novo Template</li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="mb-10">
                                ...
                                <textarea name="descricao" class="form-control form-control-solid" rows="2"></textarea>
                            </div>
