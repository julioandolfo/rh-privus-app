...
$descricoes_paginas = [
    ...
    'feedback_solicitar.php' => 'Solicitar Feedback',
    'feedback_solicitacoes.php' => 'Minhas Solicitações',
    ...
    'horas_extras.php' => 'Horas adicionais (prestadores)',
    ...
    'comunicados.php' => 'Ver Comunicados',
    'comunicado_add.php' => 'Adicionar Comunicado',
    'comunicado_view.php' => 'Visualizar Comunicado',
    'contratos.php' => 'Contratos',
    'contrato_add.php' => 'Criar Contrato',
    'contrato_view.php' => 'Visualizar Contrato',
    'contrato_templates.php' => 'Templates de Contrato',
    'contrato_template_add.php' => 'Adicionar Template',
    'contrato_template_edit.php' => 'Editar Template',
    'configuracoes_autentique.php' => 'Configurações Autentique',
...
$paginas_por_categoria = [
    ...
    'Comunicados' => ['comunicados.php', 'comunicado_add.php', 'comunicado_view.php'],
    'Colaboradores' => ['colaboradores.php', 'colaborador_add.php', 'colaborador_view.php', 'colaborador_edit.php', 'promocoes.php', 'horas_extras.php', 'fechamento_pagamentos.php', 'tipos_bonus.php', 'contratos.php', 'contrato_add.php', 'contrato_view.php', 'contrato_templates.php', 'contrato_template_add.php', 'contrato_template_edit.php'],
    ...
    'Configurações' => ['configuracoes_email.php', 'configuracoes_onesignal.php', 'configuracoes_pontos.php', 'templates_email.php', 'configuracoes_autentique.php', 'permissoes.php'],
